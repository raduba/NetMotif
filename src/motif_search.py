...
def _randomized_esu(
    ...
    return ESU(G_random, motif_size, graph_type, probabilities=probabilities)
...
def random_esu(
    ...
    """
    task_params = [
        (G_mimicked, motif_size, graph_type, seed, probabilities) for _ in range(number_of_graphs)
    ]
